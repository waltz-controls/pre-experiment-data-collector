...
/**
 * Supports only GET method. Attempt to call POST method will fail.
 * <p/>
 *
 * @author Igor Khokhriakov <igor.khokhriakov@hzg.de>
 * @since 26.03.12
 */
public abstract class ApplicationGetServlet extends BaseServlet {
    /**
    ...
    protected String doPostInternal(Users.User user, Map<RequestParameter, String> requestParameters, HttpServletRequest req) throws BackendException {
        throw new BackendException("This servlet [" + getClass().getName() + "] does not support POST method.", new UnsupportedOperationException());
    }
}
