...
MVC.Scrollable = MVC.Class.extend({
    ...
    dropmove: function(params) {
        ...
        var dimensions = MVC.Element.dimensions(location_object), position = MVC.Element.offset(location_object);

        //how close our mouse is to the boundries
        var bottom = position.y() + dimensions.y() - mouse.y(), top = mouse.y() - position.y(), right = position.x() + dimensions.x() - mouse.x(), left = mouse.x() - position.x();
